        ...
        <section id="projects" className="py-20 b-gray relative">
          ...
          <div className="row justify-content-center margin-top-45">
            <div className="col-9 skills-container projectContainers">
              ...
              <div className={`container-projects ${ expandedContainerId === 7 ? 'expand' : ''}`}>
                <header>
                ...
                <main>
                  ...
                  <footer>
                    ...
                    <button onClick={() => handleExpandContainer(7)}>
                      {expandedContainerId === 7 ? translations[language].retract_btn : translations[language].expand_btn}
                    </button>
                  </footer>
              </div>
